...
public class TherapistController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        generateId();
          ...
          // Table row select
        tblTherapist.getSelectionModel().selectedItemProperty().addListener((o, ov, sel) -> {
            if (sel != null) {
    ...
    private void loadTable() {
        try {
            ...
            bo.getAll().forEach(d -> list.add(new TherapistTM(
                    d.getId(), d.getName(), d.getEmail(), d.getPhone(), d.getSpecialization()
            )));
